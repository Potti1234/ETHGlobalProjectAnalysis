      ...
      <section className='space-y-2 text-sm text-muted-foreground'>
        ...
        <ul className='list-disc space-y-1 pl-6'>
          ...
          <li>
            ...
            this Agreement) refers to EthGlobal Project Analysis.
          </li>
          <li>
          ...
          <li>
            <strong>Website</strong> refers to WebAppTemplate, accessible from{' '}
            <a
              href='https://webapptemplate.com'
              rel='noreferrer'
              target='_blank'
            >
              https://webapptemplate.com
            </a>
          </li>
          <li>
